...
Based on the ROC curve and the AUC, the logistic regression model performed relatively well. Since the AUC is 0.8616946, the model does fairly well at discriminating between classes (whether a person survived or not). Also the ROC curve is curved upward towards the left, which explains the high AUC.
