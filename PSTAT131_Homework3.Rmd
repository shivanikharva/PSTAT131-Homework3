...
titanic_recipe <- recipe(survived ~ pclass + sex + age + sib_sp + parch + fare, data = titanic_train) %>% 
  ...
  step_impute_linear(age, impute_with = imp_vars
                     
                     
                     
                     (pclass, sex, sib_sp, parch, fare)) %>% 
...
The logistic regression has an accuracy of 0.8138042.  
...
# Finding AUC
auc(titanic_test$survived, log_test_tibble$.pred_Yes)
```
